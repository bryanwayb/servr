...
function workerSendData(id, data, worker) {
    if(!worker) {
        worker = process;
    }
...
function workerProcessData(id, callback, worker) {
    if(!worker) {
        worker = process;
    }
...
module.exports = {
    ...
    workerSendData: workerSendData,
    workerProcessData: workerProcessData
};