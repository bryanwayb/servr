...
module.exports = {
    request: function(config, request, response) {
        ...
        // Override the response.write and response.end methods. They both need to be overridden
        // because end() will write the content length before write() is called internally
        ...
        response.end = function() {
            response.write = responseWrite; // Reset back since we're doing the encoding here
